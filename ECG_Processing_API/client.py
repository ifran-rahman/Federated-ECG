## This script deals with posting and getting data from the API(s)
...
upload_signal = requests.post(url, json = data)


print(upload_signal.text)

# get processed heartbeats

beats_json = 0 #later add codes of json parsed beats json

json_data = upload_signal.json()
